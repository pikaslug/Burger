...
Here are the instructions to do this project on your own from scratch.
...
## Tech
The app is written with MySQL, Express, JavaScript/JQuery, Handlebars and Materialize css, and deployed on Heroku.

## Learn by Cloning
If you prefer, clone this repo, follow the instructions and learn by fixing errors (it's MySQL + Heroku ~ you are guaranteed to run into a least a few). 
...
Open the project folder in your IDE and locate the config folder. In the `connection.js` file, edit the server & login info for your MySQL installation. 
